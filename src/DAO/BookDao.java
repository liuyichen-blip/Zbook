...
public class BookDao {
	public static final String insert_sql="insert into book(book_name,book_author,book_ISBN,book_price,book_state)values(?,?,?,?,?)";
	public static final String find_sql="select * from book where book_ISBN=? ";
	public static final String delete_sql="delete from book where book_ISBN=? ";
	public static final String modify_sql="update book set book_name=?,book_author=?,book_ISBN=?,book_price=?,book_state=? where book_ISBN=?";
	public static final String modify_bookState_sql="update book set book_state=? where book_ISBN=?";
