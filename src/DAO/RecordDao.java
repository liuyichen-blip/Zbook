...
public class RecordDao {
	public static String Insert_sql = "insert into borrow_message(book_name,book_ISBN,user_name,borrow_date,return_date,huan,yuyue)values(?,?,?,?,?,?,?)";
	public static String Delete_sql = "delete * from borrow_message where book_ISBN=?";
	public static String Find_sql = "select * from borrow_message where user_name=?";
	public static final String find_all_sql = "select * from borrow_message";
	public static final String find_by_ISBN = "select * from borrow_message where book_ISBN=? and huan=?";
	public static final String modify_sql = "update borrow_message set return_date=?,huan=? where book_ISBN=? and huan=?";
	public static final String modify_sql2 = "update borrow_message set yuyue=? where book_ISBN=?";
